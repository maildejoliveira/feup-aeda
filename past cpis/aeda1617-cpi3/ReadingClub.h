...
class ReadingClub {
	vector<Book*> books; //todos os livros existentes msm q sejam o msm livro mas de diferentes pessoas/ediçoes
	...
	priority_queue<User> readerCandidates; //classifica leitores e da premios mediante posição
public:
	ReadingClub();

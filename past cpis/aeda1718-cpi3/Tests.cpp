...
void test_A_() {
	...
	if (3 == e1.getConsultants().size()) cout << "test succeed\n";
	else cout << "test failed";
	Expertize e2 = organization.getExpertize("Data Science", 100);
	if (1 == e2.getConsultants().size())cout << "test succeed\n";
	else cout << "test failed";
	Expertize e3 = organization.getExpertize("OOP", 40);
	if (1 == e3.getConsultants().size()) cout << "test succeed\n";
	else cout << "test failed";
	Expertize e4 = organization.getExpertize("OOP", 100);
	if (0 == e4.getConsultants().size()) cout << "test succeed\n";
	else cout << "test failed";
...
void test_C_() {
	...
	*/
	...
	if (false == assignment1) cout << "test succeed\n";
	else cout << "test failed";

	bool assignment2 = organization.assignProjectToStudent(p1, s1);
	if (true == assignment2) cout << "test succeed\n";
	else cout << "test failed";
	if ("Joao" ==  p1->getConsultant()->getName()) cout << "test succeed\n";
	else cout << "test failed";

	bool assignment3 = organization.assignProjectToStudent(p1, s3);
	if (false == assignment3) cout << "test succeed\n";
	else cout << "test failed";
	if ("Joao" == p1->getConsultant()->getName()) cout << "test succeed\n";
	else cout << "test failed";

	bool assignment4 = organization.assignProjectToStudent(p2, s2);
	if (true == assignment4) cout << "test succeed\n";
	else cout << "test failed";
	if ("Maria"== p2->getConsultant()->getName()) cout << "test succeed\n";
	else cout << "test failed";

	bool assignment5 = organization.assignProjectToStudent(p3, s1);
	if (false == assignment5) cout << "test succeed\n";
	else cout << "test failed";
}
...
void test_D_() {
	...
	*/
	...
	if (1 ==  sl1.size()) cout << "test succeed\n";
	else cout << "test failed";
	if ("t.silva@gmail.com" == sl1[0].getEMail()) cout << "test succeed\n";
	else cout << "test failed";

	organization.addStudent(&s2);
	vector<StudentPtr> sl2 = organization.getStudents();
	if (1 == sl2.size()) cout << "test succeed\n";
	else cout << "test failed";
...
void test_E_() {
	...
	sl1 = o1.getStudents();
	if ("tiago.sousa@gmail.com" == sl1[0].getEMail()) cout << "test succeed\n";
	else cout << "test failed";
	...
	for (unsigned i = 0; i < sl3.size(); i++) {
		if (sl3[i].getName() == "Ana") {
			if ("a.gomes@gmail.com"== sl3[i].getEMail()) cout << "test succeed\n";
			else cout << "test failed";
		}
	}
...
void test_F_() {
	...
	if (1 == o1.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";

	FEUPConsulting o2;
	o2.addActiveStudents(candidates_0, 2);
	if (0 == o2.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";

	FEUPConsulting o3;
	o3.addActiveStudents(candidates_5, 3);
	if (2 == o3.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";
	if ("Pedro"== o3.getActiveStudents().top().getName()) cout << "test succeed\n";
	else cout << "test failed";
	...
	if (1 == o4.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";
	...
	if (1 == o5.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";
...
void test_G_() {
	...
	if (0 == o1.mostActiveStudent(maximus)) cout << "test succeed\n";
	else cout << "test failed";
	...
	if (0 == o2.mostActiveStudent(maximus)) cout << "test succeed\n";
	else cout << "test failed";
	if (3 ==  o2.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";
	...
	if (3 == o3.mostActiveStudent(maximus)) cout << "test succeed\n";
	else cout << "test failed";
	if ("Pedro"== maximus.getName()) cout << "test succeed\n";
	else cout << "test failed";
	if (3 == o3.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";
	...
	if (2 == o4.mostActiveStudent(maximus)) cout << "test succeed\n";
	else cout << "test failed";
	if ("Maria" == maximus.getName()) cout << "test succeed\n";
	else cout << "test failed";
	if (2 == o4.getActiveStudents().size()) cout << "test succeed\n";
	else cout << "test failed";
}

...
void Pitch::addMaintenance(Maintenance *maintenance) {
    maintenances.insert(MaintenanceRecord(maintenance->getLiftCode(), maintenance->getMaintenanceDate(),
                                          maintenance->getMaintenanceSchedule(), maintenance->getSpNIF()));
}
...
Employee *Pitch::getBestEvaluatedEmployee() {
    ...
    if (serviceProviders.top().getServiceProvider()->getEvaluation() > contractedEmployees.top().getContractedEmployee()->getEvaluation())
        return serviceProviders.top().getServiceProvider();
    else if (serviceProviders.top().getServiceProvider()->getEvaluation() == contractedEmployees.top().getContractedEmployee()->getEvaluation() &&
             serviceProviders.top().getServiceProvider()->getNumOfReviews() > contractedEmployees.top().getContractedEmployee()->getNumOfReviews())
        return serviceProviders.top().getServiceProvider();
    else
...
void Pitch::addContractedEmployee(ContractedEmployee *e) {
    contractedEmployees.push(e);
